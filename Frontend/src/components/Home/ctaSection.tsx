      ...
      <Container maxWidth="lg">
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Typography variant="h2" sx={{ mb: 3, fontWeight: 'bold', fontSize: { xs: '2.5rem', md: '3.5rem' } }}>
          ...
          <Grid item xs={12} md={5}>
            <Box sx={{ display: 'flex', justifyContent: 'space-around', mt: { xs: 4, md: 0 } }}>
              {[
                { icon: SchoolRounded, label: 'Quality Education' },
                { icon: MonetizationOnRounded, label: 'Affordable Loans' },
