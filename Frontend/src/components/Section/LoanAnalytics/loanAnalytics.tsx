...
//           <MetricCard title="Total Applications" value={356} color={COLORS[0]} />
//         </Grid>
//         <Grid item xs={12} sm={6} md={3}>
//           <MetricCard title="Approved Loans" value={162} color={COLORS[1]} />
//         </Grid>
//         <Grid item xs={12} sm={6} md={3}>
//           <MetricCard title="Rejection Rate" value="23%" color={COLORS[2]} />
//         </Grid>
//         <Grid item xs={12} sm={6} md={3}>
//           <MetricCard title="Avg. Processing Time" value="3.2 days" color={COLORS[3]} />
//         </Grid>
...
//                 <YAxis />
//                 <Tooltip />
//                 <Bar dataKey="applications" fill={COLORS[0]} />
//               </BarChart>
//             </ResponsiveContainer>
//           </Paper>
//         </Grid>
